...
import { Cog6ToothIcon, BellIcon, UserCircleIcon } from '@heroicons/react/24/outline';
        ...
        <Card title="Profile Information">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 rounded-full bg-linear-to-br from-emerald-500 to-green-500 flex items-center justify-center text-white text-2xl font-bold">
                {user?.name?.charAt(0) || 'H'}
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900">{user?.name}</h3>
                <p className="text-gray-500">HOD - {user?.department}</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                desc: 'Get notified for leave requests',
              },
              {
                key: 'attendanceAlerts',
                label: 'Attendance Alerts',
                desc: 'Alerts for attendance issues',
              },
              { key: 'weeklyReports', label: 'Weekly Reports', desc: 'Receive weekly summary' },
            ].map((item) => (
              <div
                key={item.key}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField label="Default View">
                ...
                >
                  ...
                  <option value="employees">Department Staff</option>
