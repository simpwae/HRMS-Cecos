              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 focus:border-[hsl(var(--cecos-maroon))] focus:ring-2 focus:ring-[hsl(var(--cecos-maroon)/0.1)] transition-all outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-10 pr-12 py-2.5 rounded-lg border border-gray-200 focus:border-[hsl(var(--cecos-maroon))] focus:ring-2 focus:ring-[hsl(var(--cecos-maroon)/0.1)] transition-all outline-none"
                    required
                  />
                  <button
                    type="button"
